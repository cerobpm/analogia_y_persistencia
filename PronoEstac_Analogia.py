...
dic_Metodo={'Analogias':{   'Prono':True,
                            'Calc_Error':False}}
...
for CB_i in list(Estaciones.keys()):
    ...
    #if nomEst !=  'Puerto Pilcomayo':  continue# Concepcion
    ...
    if dic_Metodo['Analogias']['Calc_Error']:
        MetodoAnalogia_errores_v2(nomEst,df_resamp,ObjSerie_i.var,vent_resamp,Param_Modelos,connBBDD=conn)
...
if saveBBDD_Alerta:
    ...
    if dic_Metodo['Analogias']['Prono']: 
        GuardaEnBBDD(series_analogia,fecha_emision,492)# Guarda en BBDD
